...
%     PLOT_AVERAGE_MENU = uimenu(BRAINWAVE_MENU,'label','Plot Average','separator','on','Callback',@average_callback);
    ...
    DATA_SOURCE_MENU = uimenu(BRAINWAVE_MENU,'label','Data source');
...
%                 'separator','on','Callback',@data_menu_callback);        
    ...
    % highlighted in green.
        ...
        title(['Head and Sensor Motion Data for Subject ', name(1:2)]);
        xlabel 'Time (s)';
        ...
        % Patch height is supposed to be slightly taller than the maximum y value.
            ...
            legend('Head motion', 'Sensor motion', 'Rejected epochs', 'Location', 'bestoutside')
        else
            legend('Head motion', 'Sensor motion', 'Location', 'bestoutside')
