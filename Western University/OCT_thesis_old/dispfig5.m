function dispfig5(z,mu)
figure(4)
clf
set(gcf,'Units','centimeters','Position',[19.5 1.3 10 16.7])
plot(mu,z,'k','Linewidth',1.5); set ( gca, 'ydir','reverse' );
title('Averaged A-scan (Vermeer)')
axis on
fontSize=15;
ylim([0 z(end)])
xlim([0 6])
set(gca,'XTick',[0:1:6],'FontSize', fontSize)
...
xlabel('Scattering Coefficient [mm^-1]','FontSize', fontSize)
grid on
